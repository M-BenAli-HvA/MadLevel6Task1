...
import com.example.madlevel6task1.adapters.ColorAdapter
import com.example.madlevel6task1.models.ColorItem
import com.example.madlevel6task1.viewmodels.ColorViewModel
...
class ColorFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rvColors.layoutManager = LinearLayoutManager(activity,
    ...
    private fun observeColors() {
        colorViewModel.colorItems.observe(
            viewLifecycleOwner,
            Observer {
                colors.clear()
                colors.addAll(it)
